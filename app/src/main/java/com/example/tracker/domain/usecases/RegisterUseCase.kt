...
class RegisterUseCase(transformer: Transformer<Boolean>, private val auth: FireBaseAuthRepo) :UseCase<Boolean>(transformer)  {
    ...
    override fun createObservable(data: Map<String, Any>?): Observable<Boolean> {
        ...
        if (password != null && email != null) {
            return auth.signUp(email, password).toObservable().map {  true}
        }
